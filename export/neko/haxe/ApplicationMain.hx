...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FunkinKD", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("FunkinKD", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "42";
		app.meta["company"] = "494kd";
		app.meta["file"] = "FunkinKD";
		app.meta["name"] = "FunkinKD";
	...
	macro public static function getEntryPoint()
	{
		...
		switch (Context.follow(Context.getType("kd.backend.main.EntryPoint")))
		{
			case TInst(t, params):
				...
				if (hasMain)
				{
					return Context.parse("@:privateAccess kd.backend.main.EntryPoint.main()", Context.currentPos());
				}
				...
				{
					Context.fatalError("Main class \"kd.backend.main.EntryPoint\" has neither a static main nor a constructor.", Context.currentPos());
				}

			default:

				Context.fatalError("Main class \"kd.backend.main.EntryPoint\" isn't a class.", Context.currentPos());
		}
...
@:keep @:dox(hide) class DocumentClass extends kd.backend.main.EntryPoint {}
#else
class DocumentClass
{
